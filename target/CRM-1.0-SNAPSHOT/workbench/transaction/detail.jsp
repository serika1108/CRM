...
<%@ page import="crm.settings.domain.DicValue" %>
...
<script type="text/javascript">
	...
	function changeStage(stage, i){
		$.ajax({
			...
			success: function (data){
				/*
				data
					{"success":true/false,"t":{交易信息，即用来刷新相关页面的信息，封装在了对象中}}
				 */
				if(data.success){
					//改变成功，需要在详细信息页面上局部刷新
	...
	function changeIcon(stage, index){
		//取得当前阶段，可能性，下标，正常阶段和异常阶段的分界点下标
		let currentStage = stage;
		let currentPossibility = $("#possibility").html();
		//这里是java里的变量转换成JavaScript的变量，必须是八大基本类型或者string
		let point = <%=point%>;

		//如果当前阶段可能性是0，正常阶段是黑全，后面异常阶段是红叉和黑叉
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			if("0".equals(currentPossibility)){
				//如果当前阶段可能性为0，正常交易阶段的图标变黑，后面异常阶段出现问题的成红叉，其余的是黑叉
				for(int i = 0; i < dvList.size(); i++){
					DicValue dv = dvList.get(i);
		...
		<%
			...
			//如果当前阶段可能性不为0，则前面正常阶段是绿色的，后面异常阶段是黑的的
			else{
				//当前阶段的下标
				int index = 0;
				for(int i = 0; i < dvList.size(); i++){
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 90px;">
			<div style="width: 300px; color: gray;">${t.contactSummary}</div>
			<div style="width: 630px;position: relative; left: 200px; top: -20px;">
				<b>
					&nbsp;
				</b>
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>备注123</h5>
				<font color="gray">交易</font> <font color="gray">-</font> <b>交易</b> <small style="color: gray;"> 2021-01-22 10:10:10 由张三</small>
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>备注456</h5>
				<font color="gray">交易</font> <font color="gray">-</font> <b>交易</b> <small style="color: gray;"> 2021-01-22 10:20:10 由张三</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
