...
<script>
	...
	$(function () {
		...
		//为阶段下拉框绑定事件，为选中阶段填写可能性
		$("#create-stage").change(function () {
			//取得选中的阶段
			let stage = $("#create-stage").val();
			//选中阶段和对应的可能性是pMap，但pMap是java语言，这是在JavaScript中
			//将pMap转换成json的键值对即可以进行取值
			//注意stage是一个变量，当key是变量时，就不能用传统的json.key取值，需要用中括号
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="36c830e650744955a659c576a5c346f6"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="小明">
				<input type="hidden" name="contactsId" value="f2f8abbb0358451f98b5d44e4f8eff33">
			</div>
		</div>
