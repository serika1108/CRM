...
<script type="text/javascript">
	...
	$(function(){
		...
		//页面加载完成后取出对应的市场活动信息列表
		showActivityList();

		//为搜索关联市场活动的模态窗口的搜索框绑定事件，通过触发回车键来查询并展现所需市场活动列表
		$("#aname").keydown(function (event) {
			...
			if(event.keyCode==13){
				...
				//需要注意，对于模态窗口点击回车会自动清空并关闭当前模态窗口，强制刷新页面
				//因此查询后要禁用默认功能，禁用的方法是直接结束这个方法
				return false;
			}
		})
	...
	function showActivityList(){
		...
		$.ajax({
			...
			success: function (data) {
				...
				//在查询里面得到的activity对象的id是关系表的id，已经不是活动的id了
				$.each(data, function (i,n) {
					html += '<tr>';
					html += '<td>'+n.name+'</td>';
					html += '<td>'+n.startDate+'</td>';
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<%--不经过后台传递详细信息，通过地址栏挂参数
			这是有条件的，首先不能包含敏感信息，其次地址不能太长，会超出浏览器所能容纳的最长字符范围--%>
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>备注123</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>李四先生</b> <small style="color: gray;"> 2021-01-22 10:10:10 由张三</small>
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>备注4556</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>李四先生</b> <small style="color: gray;"> 2021-01-22 10:20:10 由张三</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
